# Извлечь все слова, которые начинаются на согласную букву из текста https://ru.lipsum.com/feed/html
...
result = re.findall(r'\b[bcdfghjklmnpqrstvwxz]\w+', lorem, flags=IGNORECASE)
print(result)
